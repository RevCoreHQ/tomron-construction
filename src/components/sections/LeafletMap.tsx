...
export default function LeafletMap() {
  ...
  const primaryIcon = new L.Icon({
    iconUrl: 'data:image/svg+xml;base64,' + btoa(
      '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="40" viewBox="0 0 28 40"><path d="M14 0C6.268 0 0 6.268 0 14c0 10.5 14 26 14 26s14-15.5 14-26C28 6.268 21.732 0 14 0z" fill="#dc5a2c"/><circle cx="14" cy="14" r="6" fill="white"/></svg>'
    ),
    iconSize: [28, 40],
    iconAnchor: [14, 40],
    popupAnchor: [0, -42],
  ...
  const extendedIcon = new L.Icon({
    iconUrl: 'data:image/svg+xml;base64,' + btoa(
      '<svg xmlns="http://www.w3.org/2000/svg" width="28" height="40" viewBox="0 0 28 40"><path d="M14 0C6.268 0 0 6.268 0 14c0 10.5 14 26 14 26s14-15.5 14-26C28 6.268 21.732 0 14 0z" fill="#64748b"/><circle cx="14" cy="14" r="6" fill="white"/></svg>'
    ),
    iconSize: [28, 40],
    iconAnchor: [14, 40],
    popupAnchor: [0, -42],
  ...
  const hqIcon = new L.Icon({
    iconUrl: 'data:image/svg+xml;base64,' + btoa(
      '<svg xmlns="http://www.w3.org/2000/svg" width="34" height="46" viewBox="0 0 34 46"><path d="M17 0C7.611 0 0 7.611 0 17c0 12.75 17 29 17 29s17-16.25 17-29C34 7.611 26.389 0 17 0z" fill="#dc5a2c"/><path d="M17 0C7.611 0 0 7.611 0 17c0 12.75 17 29 17 29s17-16.25 17-29C34 7.611 26.389 0 17 0z" fill="none" stroke="#b5441f" stroke-width="1.5"/><circle cx="17" cy="17" r="8" fill="white"/><text x="17" y="21" text-anchor="middle" font-size="12" font-weight="bold" fill="#dc5a2c" font-family="sans-serif">&#9733;</text></svg>'
    ),
    iconSize: [34, 46],
    iconAnchor: [17, 46],
    popupAnchor: [0, -48],
