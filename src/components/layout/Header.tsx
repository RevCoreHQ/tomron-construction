...
export function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile backdrop — OUTSIDE header to avoid backdrop-filter containing block */}
      {mobileOpen && (
        <div
      ...
      {/* Mobile slide-out panel — OUTSIDE header */}
      <div
        className={cn(
          'lg:hidden fixed inset-y-0 right-0 w-80 max-w-[85vw] bg-charcoal-950 z-[70] flex flex-col transform transition-transform duration-300 ease-in-out',
