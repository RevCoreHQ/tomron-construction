...
export const services: ServiceData[] = [
  {
    ...
    category: 'exterior',
    metaTitle: 'Siding & Cladding Installation | Tomron Construction',
    metaDescription: 'Professional siding and cladding installation in Maple Ridge, Coquitlam & the Lower Mainland. Free quotes. Call (604) 754-9392.',
  ...
  },
  {
    ...
    category: 'exterior',
    metaTitle: 'Metal Flashing Installation & Repair | Tomron',
    metaDescription: 'Custom metal flashing for windows, doors, and rooflines. Protect your home from water damage. Serving Maple Ridge & the Lower Mainland.',
  ...
  },
  {
    ...
    category: 'exterior',
    metaTitle: 'Building Envelope Solutions | Tomron Construction',
    metaDescription: 'Building envelope services: air barriers, moisture management, and insulation. Protect your Lower Mainland home. Free quotes.',
  ...
  },
  {
    ...
    category: 'renovation',
    metaTitle: 'Home Renovation Contractor | Tomron Construction',
    metaDescription: 'Full home renovations in Maple Ridge, Coquitlam & the Lower Mainland. Single rooms to complete transformations. Free quotes.',
  ...
  },
  {
    ...
    category: 'openings',
    metaTitle: 'Window Replacement | Tomron Construction',
    metaDescription: 'Window replacement in Maple Ridge, Coquitlam & the Lower Mainland. Casement, sliding, picture, tilt-n-turn & more. Free quotes.',
  ...
  },
  {
    ...
    category: 'openings',
    metaTitle: 'Door Replacement & Installation | Tomron Construction',
    metaDescription: 'Entry door and patio door replacement in Maple Ridge, Coquitlam & the Lower Mainland. Energy-efficient options, expert installation.',
